...
namespace OthelloUI
{
    public partial class FormGame : Form
    {
        ...
        private const int k_PictureBoxSize = 75;
        ...
        {
            this.SuspendLayout();
            this.ClientSize = new System.Drawing.Size((r_BoardSize * 75), (r_BoardSize * 75));
            this.Margin = new System.Windows.Forms.Padding(0, 0, 0, 0);
            r_TableLayoutPanelForPictureBoxes.Size = new System.Drawing.Size((r_BoardSize * 75), (r_BoardSize * 75));
            r_TableLayoutPanelForPictureBoxes.CellBorderStyle =
            ...
            r_TableLayoutPanelForPictureBoxes.Anchor =
                AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Bottom;

            for(int i = 0; i < r_BoardSize; i++)
            {
                r_TableLayoutPanelForPictureBoxes.ColumnStyles.Add(
                    new ColumnStyle(SizeType.Percent, 100.0f / r_BoardSize));
        ...
        public void UpdateTablePictureBox(string i_Color, int i_Row, int i_Col)
        {
            PictureBox currentPictureBox =
                r_TableLayoutPanelForPictureBoxes.GetControlFromPosition(i_Col, i_Row) as PictureBox;
        ...
        private void pictureBox_Click(object sender, EventArgs e)
        {
            ...
            if(clickedPictureBox != null)
            {
                TableLayoutPanelCellPosition position =
                    r_TableLayoutPanelForPictureBoxes.GetPositionFromControl(clickedPictureBox);
        ...
        {
            foreach (Control control in r_TableLayoutPanelForPictureBoxes.Controls)
            {
...
//        private void timerFallingPic_Tick(object sender, EventArgs e)
//        {
//            PictureBox mySender = sender as PictureBox;
//            if(mySender != null)
//            {

//                if(mySender.Bottom >= r_TableLayoutPanelForPictureBoxes.Height)
//                {
//                    doWhenReachedBottom(mySender);
//                }
//                else
//                {
//                    mySender.Top += 1;
...
//                    {
//                        doWhenReachedBottom(pictureBox);
//                    }
//                    else
//                    {
//                        pictureBox.Top += 1;
...
//                    pictureBox.Enabled = false;
//                    timerFallingPic.Start();
//                }
//            }

//        }

//        private void doWhenReachedBottom(PictureBox pictureBox)
//        {
//            pictureBox.Top = this.ClientSize.Height - pictureBox.Height;
//            timerFallingPic.Stop();
//        }
//    }
//}
